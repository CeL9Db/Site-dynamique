<?php
    ...
    if($current_page == "/myhost-exemple/dragons_dogma_2_page.php")
    {
        ...
        <div id="game_page">
            ...
            <div class="configuration_game">
                <fieldset>
                    ...
                    <ul type="*">
                        <span>  
                            <li class="liste_abc_none_style">OS: Windows 10 (64 bit) / Windows 11 (64 bit)</li>
                            <li class="liste_abc_none_style">CPU: Intel Core i5 10600 / AMD Ryzen 5 3600</li>
                            <li class="liste_abc_none_style">RAM: 16GB</li>
                            <li class="liste_abc_none_style">GPU: NVIDIA GeForce GTX 1070 / AMD Radeon RX 5500 XT</li>
                    ...
                    <ul type="*">
                        <span>  
                            <li class="liste_abc_none_style">OS: Windows 10 (64 bit)/Windows 11 (64 bit)</li>
                            <li class="liste_abc_none_style">CPU: Intel Core i7-10700 / AMD Ryzen 5 3600X</li>
                            <li class="liste_abc_none_style">RAM: 16GB</li>
                            <li class="liste_abc_none_style">GPU: NVIDIA GeForce RTX 2080 / AMD Radeon RX 6700</li>
                            <li class="liste_abc_none_style">VRAM : 8 GB</li>
                            <li class="liste_abc_none_style">Direct X : 12</li>
                        </span>
                    </ul>
            ...
            <div class="actualites_game">
                <fieldset>
                    ...
                    <div class="actualite">
                        ...
                        <a href="https://www.jeuxvideo.com/news/1880244/sur-dragon-s-dogma-2-le-resultat-est-dingue-apres-le-ray-tracing-cette-nouvelle-technologie-fait-des-merveilles.htm"><span><b>Sur Dragon's Dogma 2, le résultat est dingue ! Après le ray tracing, cette nouvelle technologie fait des merveilles...</b> <br><br>Digital Foundry a mis en avant une fonctionnalité saisissante dans une vidéo consacrée à Dragon's Dogma II et ses graphismes. Le résultat est bluffant...</span></a>
                    </div>
                    <div class="actualite">
                        <img src="<?php echo $data['actualite_2']; ?>" class="photo_jeu_page">
                        <a href="https://www.jeuxvideo.com/news/1876054/il-aurait-trouve-une-fin-secrete-100-inedite-pour-dragon-s-dogma-2-il-a-ose-defier-le-brouillard.htm"><span><b>Il aurait trouvé une fin secrète 100% inédite pour Dragon's Dogma 2 : il a osé défier le brouillard</b> <br><br>Un joueur vient de découvrir ce qu’il pense être une fin secrète de Dragon’s Dogma 2, bien cachée au cœur d'un brouillard. On vous explique la marche à suivre, mais attention aux spoilers !</span></a>
                    </div>
                    <div class="actualite">
                        <img src="<?php echo $data['actualite_3']; ?>" class="photo_jeu_page">
                        <a href="https://www.jeuxvideo.com/news/1874093/cenotaphe-hante-dragon-s-dogma-2-ou-le-trouver.htm"><span><b>Cénotaphe hanté Dragon's Dogma 2 : Où le trouver ?</b> <br><br>Un marchand ambulant vous a parlé d’un cénotaphe dans Dragon’s Dogma 2, mais vous ne savez pas où il se trouve, bien qu’il soit à proximité du Village étape ?</span></a>
                    </div>
                </fieldset>
            </div>
